anestheticStatCtrl.$inject = ['$rootScope', '$scope', 'IHttp', '$filter', '$timeout', 'auth', 'toastr', '$uibModal', 'uiGridServe'];

module.exports = anestheticStatCtrl;

function anestheticStatCtrl($rootScope, $scope, IHttp, $filter, $timeout, auth, toastr, $uibModal, uiGridServe) {
    ...
    function getPage(self) {
        ...
        IHttp.post('basedata/cntMedicineUseByOperat', params).then(function(rs) {
    ...
    $scope.showOut = function(row) {
        ...
        var modalInstance=$uibModal.open({
            animation: true,
            size: 'lg',
            template: require('../myStock/anestheticStat_dialog.html'),
            controller: require('../myStock/anestheticStat_dialog.controller'),
