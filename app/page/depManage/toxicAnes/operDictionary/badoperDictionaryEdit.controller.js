badoperDictionaryEditCtrl.$inject = ['$rootScope', '$scope','confirm', 'IHttp','i18nService','uiGridConstants','$timeout','toastr', '$uibModalInstance', 'select', '$filter', 'auth'];

module.exports = badoperDictionaryEditCtrl;

function badoperDictionaryEditCtrl($rootScope, $scope,confirm,  IHttp,i18nService,uiGridConstants,$timeout,  toastr, $uibModalInstance, select, $filter, auth) {
    vm = this;
    vm.title="报损";
