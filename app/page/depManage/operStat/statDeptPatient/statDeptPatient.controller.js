StatDeptPatientCtrl.$inject = ['$rootScope', '$scope', 'IHttp', 'i18nService', 'uiGridConstants', '$timeout', 'toastr'];

module.exports = StatDeptPatientCtrl;

function StatDeptPatientCtrl( $rootScope, $scope, IHttp, i18nService, uiGridConstants, $timeout, toastr) {
	$scope.gridOptions = {
        resizable: true,
        rowHeight: 40,
        ...
        enableGridMenu: true,
        exporterCsvFilename:'科内手术统计表及明细.csv',
