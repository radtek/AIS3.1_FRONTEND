StatAnaesthesiaCasesCtrl.$inject = ['$rootScope', '$scope', 'IHttp', 'i18nService', 'uiGridConstants', '$timeout', 'toastr'];

module.exports = StatAnaesthesiaCasesCtrl;

function StatAnaesthesiaCasesCtrl( $rootScope, $scope, IHttp, i18nService, uiGridConstants, $timeout, toastr) {
	...
	$scope.gridOptions = {
	    ...
	    exporterCsvFilename: '麻醉科麻醉例数统计.csv',
	...
	$scope.$on('query',function(ev, data){
		IHttp.post('statistics/countAnaesDeptByMethodType', data).then((rs) => {
