StatStewardScoreCtrl.$inject = ['$rootScope', '$scope', 'IHttp', 'i18nService', 'uiGridConstants', '$timeout', 'toastr'];

module.exports = StatStewardScoreCtrl;

function StatStewardScoreCtrl( $rootScope, $scope, IHttp, i18nService, uiGridConstants, $timeout, toastr) {
	...
	$scope.$on('query',function(ev, data){
		IHttp.post('statistics/searchStewardScoByPacu', data).then((rs) => {
