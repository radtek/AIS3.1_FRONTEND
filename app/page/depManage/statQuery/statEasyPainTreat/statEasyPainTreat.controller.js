StatEasyPainTreatCtrl.$inject = ['$rootScope', '$scope', 'IHttp', 'i18nService', 'uiGridConstants', '$timeout', 'toastr'];

module.exports = StatEasyPainTreatCtrl;

function StatEasyPainTreatCtrl( $rootScope, $scope, IHttp, i18nService, uiGridConstants, $timeout, toastr) {
	...
	$scope.$on('query',function(ev, data){
		IHttp.post('statistics/searchOperByAnalgesic', data).then((rs) => {
