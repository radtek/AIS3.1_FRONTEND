StatAsaCtrl.$inject = ['$rootScope', '$scope', 'IHttp', 'i18nService', 'uiGridConstants', '$timeout', 'toastr'];

module.exports = StatAsaCtrl;

function StatAsaCtrl( $rootScope, $scope, IHttp, i18nService, uiGridConstants, $timeout, toastr) {
	...
	$scope.$on('query',function(ev, data){
		IHttp.post('statistics/searchRegionOperatCountByAsalev', data).then((rs) => {
