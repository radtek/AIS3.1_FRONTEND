StatCasesWithNurseCtrl.$inject = ['$rootScope', '$scope', 'IHttp', 'i18nService', 'uiGridConstants', '$timeout', 'toastr'];

module.exports = StatCasesWithNurseCtrl;

function StatCasesWithNurseCtrl( $rootScope, $scope, IHttp, i18nService, uiGridConstants, $timeout, toastr) {
	...
	$scope.gridOptions = {
	    ...
	    exporterCsvFilename: '护士-护士例数统计.csv',
	...
	$scope.$on('query',function(ev, data){
		IHttp.post('statistics/searchOperByNurse', data).then((rs) => {
