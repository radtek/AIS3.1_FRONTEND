StatOperLevelWithDeptCtrl.$inject = ['$rootScope', '$scope', 'IHttp', 'i18nService', 'uiGridConstants', '$timeout', 'toastr'];

module.exports = StatOperLevelWithDeptCtrl;

function StatOperLevelWithDeptCtrl( $rootScope, $scope, IHttp, i18nService, uiGridConstants, $timeout, toastr) {
	...
	$scope.gridOptions = {
	    ...
	    exporterCsvFilename: '科室手术等级统计.csv',
	...
	$scope.$on('query',function(ev, data){
		IHttp.post('statistics/searchDeptOperatCountByOptlev', data).then((rs) => {
