StatOperCasesWithDeptCtrl.$inject = ['$rootScope', '$scope', 'IHttp', 'i18nService', 'uiGridConstants', '$timeout', 'toastr'];

module.exports = StatOperCasesWithDeptCtrl;

function StatOperCasesWithDeptCtrl( $rootScope, $scope, IHttp, i18nService, uiGridConstants, $timeout, toastr) {
	...
	$scope.gridOptions = {
	    ...
	    exporterCsvFilename: '科室-手术例数统计.csv',
	...
	$scope.$on('query',function(ev, data){
		IHttp.post('statistics/searchOperByDept', data).then((rs) => {
