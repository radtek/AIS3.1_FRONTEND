StatAnaesthesiaLevelCasesCtrl.$inject = ['$rootScope', '$scope', 'IHttp', 'i18nService', 'uiGridConstants', '$timeout', 'toastr'];

module.exports = StatAnaesthesiaLevelCasesCtrl;

function StatAnaesthesiaLevelCasesCtrl( $rootScope, $scope, IHttp, i18nService, uiGridConstants, $timeout, toastr) {
	...
	$scope.gridOptions = {
	    ...
	    exporterCsvFilename: '麻醉分级管理例数统计.csv',
	...
	$scope.$on('query',function(ev, data){
		IHttp.post('statistics/searchOperByASALevel', data).then((rs) => {
