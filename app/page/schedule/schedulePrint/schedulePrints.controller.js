SchedulePrintCtrl.$inject = ['$rootScope', '$scope', 'IHttp', 'uiGridConstants', '$timeout', 'toastr', 'auth', '$filter', 'uiGridServe', 'select', 'baseConfig'];

module.exports = SchedulePrintCtrl;

function SchedulePrintCtrl($rootScope, $scope, IHttp, uiGridConstants, $timeout, toastr, auth, $filter, uiGridServe, select, baseConfig) {
    var promise;
