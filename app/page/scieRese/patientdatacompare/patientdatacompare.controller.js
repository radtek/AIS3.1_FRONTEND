module.exports = patientdatacompare;

patientdatacompare.$inject = ['$rootScope', '$scope', 'IHttp', 'auth', '$uibModal', 'uiGridConstants', 'toastr', '$timeout', '$filter', 'uiGridServe'];

function patientdatacompare($rootScope, $scope, IHttp, auth, $uibModal, uiGridConstants, toastr, $timeout, $filter, uiGridServe) {
    ...
    $scope.gridOptions = uiGridServe.option({
        ...
        columnDefs: [{
            ...
            width: 120,
            cellTemplate: '<div class="ui-grid-cell-contents" ><a ng-click="grid.appScope.toView(row.entity)">查看</a>&nbsp;|&nbsp;<a ng-click="grid.appScope.addCom(row.entity)">加入对比</a></div>',
        }]
    });
